...
hski_baby_num = 1 # the number of consecutive Helsinki files to be used in test
...
path_test_files = '../Helsinki files/'  # folder with EEG signal data and labels for test
