...
import sys
import pdb
from scipy import fix  # Pycharm throwing error here but does not effect calcs
resp = 145*4
threshold_pass = 0
threshold_reject = 1
...
def calc_roc(D_val, epoch_map, epoch_length):
    ...
    collar = int(30 - (epoch_length - 8)/2) # collar = (30,26,18) for input_length of (8,16,32) respectively
